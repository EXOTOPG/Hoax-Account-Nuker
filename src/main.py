...
def main():
    ...
    # Set Console title
    set_console_title("Hoax V1 | Made by Hoax#7907 | Menu")
    ...
    banner = """
                        ...
                        ╔═════════════════════════╗         ╔═════════════════════════╗
                        ║    dsc.gg/xkUxchP5bb    ║         ║    dsc.gg/xkUxchP5bb    ║
                     ╔═══════════════════════════════╗   ╔═══════════════════════════════╗
    ...
    info = f"""{Fore.LIGHTCYAN_EX}\t\t\t\t\t  [+] Made by Hoax#7907 [+]"""
    for x in info:
        time.sleep(0.0001)
        sys.stdout.write(x)
        sys.stdout.flush()
...
def socials():
    ...
    # Set Console title
    set_console_title("Hoax V1 | Made by Hoax#7907 | Socials")
